...
import { TextInputField } from "../components/UI-component/TextInput";
    ...
    return (
      ...
      <React.Fragment>
          {/* <Box>
              <Stack> */}
              <Box sx={{
                    backgroundImage: 'url(https://www.qschina.cn/sites/default/files/profiles-slideshow/dome-bldg-1.jpg)',
      ...
      <Grid2>
        <img src={crossX} style={{ height: "45%", width: "80%", position: 'relative', top: '-565px', right: '-450px' }}  />
      </Grid2>
      <Grid2 sx={{
        gridColumn: "3 / 4",
        gridRow: "1 / 2",
        ...
        <img src={LogoSC} style={{ height: "85%", width: "80%", objectFit: "contain", position: "relative", left: "30px"}} />
      </Grid2>
      <Grid2 sx={{
        gridColumn: "1 / 4",
        gridRow: "2 / 3",
      ...
      <img src={cofouderImage} 
        alt="Co-Founder"
        style={{
        marginTop: '10px',
        maxWidth: "75%", // Prevents the image from exceeding the grid cell width
        maxHeight: "100%", // Prevents the image from exceeding the grid cell height
